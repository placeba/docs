...
использоваться верстка. От контекста использования зависят следущее:
...
Существует следующие контекты использования верстки:
...
- **Управление сайтом**
  ...
  наименьшего сопротивления. Сначала пробует изменить только CSS шаблона, если этого недостачно — копирует шаблон и на его
...
- **Публичные интерфейсы**
  ...
  которые должны хорошо отображаться в _любом_ дизайне. Здесь важно, чтобы верстка была "пуленепробиваемой" - внешние стили
  шаблона не должны влиять на ее отображение.
